...
$('#filterCategory').onchange=renderNotes;$('#noteSearch').addEventListener('input',renderNotes);$('#clearNoteFilter').onclick=()=>{$('#filterCategory').value='';$('#noteSearch').value='';renderNotes()};
